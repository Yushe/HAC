...
HAC.SERVER.ECheck_LogOnly = {
	...
	"/ass_sandbox_spamprotect.lua",
	"/wehrmacht_hacks_players.lua",
	"/dmenuoptioncvar.lua",
	"/doom/autoaim",
	"/doom/cheats",
	"models/bot",
	"/sh_hax.lua",
	"/chatsounds_client_crack.lua",
	"/sligwolfs_oldbots.lua",
	"/evilscaryrobotsfromouterspace.lua",
	"/roboteyeglow_particle_mounter.lua",
	"glib/lua/detours.lua",
	"/sfx/bot.lua",
	"/cl_haxicons.lua",
	"/sh_hax_config.lua",
	"lists_nosend/techbot.lua",
	"/cl_hack_check_vgui_type.lua",
	"/botvoodoo.lua",
	"/terrorist_bot_resources.lua",
	"/terrorist_bot.lua",
	"/terrorist_bot_npc.lua",
	"lua/autorun/combot.lua",
	"lua/removerbot.lua",
}
